...
%The solution in the trusted setup model relied on the fact that for
...
%More formally, it satisfies a `conditional version' of
%Definition~\ref{def-fullymalicious}, where the
%quantification is over `harmless' $N,c$ that either don't
%satisfy some efficiently verifiable validity
%conditions, or all $c_i$ are in $(*,*,F_2)$, rather than over arbitrary $N,c$.
